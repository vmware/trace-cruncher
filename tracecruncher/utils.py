...
class trace_stream:
    ...
    def open_buffer(self, file_name, buffer_name):
        ...
        self.file_name = file_name
        self.buffer_name = buffer_name
        self.stream_id = ft.open_buffer(self.file_name, buffer_name)
    ...
    def load(self, cpu_data=True, pid_data=True, evt_data=True,
        ...
        """ Load the trace data.
        """
        return dw.load(stream_id=self.stream_id, ofst_data=ofst_data,
                                                 cpu_data=cpu_data,
                                                 ts_data=ts_data,
                                                 pid_data=pid_data,
                                                 evt_data=evt_data)
    ...
    def read_event_field(self, offset, event_id, field):
        ...
        """
        return ks.read_event_field(stream_id=self.stream_id, offset=offset,
                                                             event_id=event_id,
                                                             field=field)
